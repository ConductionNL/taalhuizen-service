...
//        $employee->setOrganizationId(end($providerIdArray));
     ...
     */
    public
    function handleUserRoleArray(array $employeeArray)
    {
     ...
     */
    public
    function handleRetrievingContact(Employee $employee, array $employeeArray): array
    {
        $contact = [];
     ...
     */
    public
    function checkUniqueEmployeeEmail(array $body, string $id = null): ?Response
    {
     ...
     */
    public
    function checkIfEmployeeExists(string $id): ?Response
    {
     ...
     */
    public
    function updateEmployee(string $id, array $employeeArray): Employee
    {
        $this->checkEmployeeValues($employeeArray);
     ...
     */
    public
    function updateEmployeeArray(string $id, array $employeeArray): array
    {
...
//            $this->saveEmployeeEducations($employeeArray['educations'], $result['id']);
     ...
     */
    public
    function setUserRoleArray(array $employeeArray)
    {
        if (key_exists('userGroupIds', $employeeArray) and isset($employeeArray['userGroupIds'][0])) {
            $userRole = $this->commonGroundService->getResource(['component' => 'uc', 'type' => 'groups', 'id' => $employeeArray['userGroupIds'][0]]);
            $userRoleArray = $this->convertUserRole($userRole);
     ...
     */
    public
    function deleteSubObjects(array $employee): bool
    {
     ...
     */
    public
    function saveEmployeeEducations(array $educations, string $employeeId): void
    {
     ...
     */
    public
    function deleteEmployees(string $ccOrganizationId): bool
    {
     ...
     */
    public
    function createEmployeeResource(array $employeeArray, array $contact, ?Employee $employee, ?array $employeeRaw)
    {
        return [
